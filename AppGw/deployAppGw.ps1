...
$AppGwParams = @"
{
    ...
    "parameters": {
        ...
        "subnetName": {
            "value": "Sentia-centralus-default"
        },
        "zones": {
            "value": []
        },
...
Set-Content -Path $ParameterFile -Value $AppGwParams

New-AzResourceGroupDeployment -ResourceGroupName $ResourceGroupName -TemplateFile $TemplateFilePath -TemplateParameterFile $AppGwParams;
